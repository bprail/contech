...
def main():
    ...
    parser.add_argument("-n", "--numthreads", help="The number of threads to run.", default="8")
...
#     print script
    return util.quicklocal(name="timed_compilation_{}".format(benchmark), code=script, resources=["nodes=1:ppn=1,pmem=1gb"], queue="newpasta")
...
"""
    ...
    print jobName
    return util.quicklocal(name=jobName, code=script, resources=["nodes=1:ppn=24,pmem=1800mb"], queue="newpasta")
